...
- (void)setUpChildViewControllers {
    ...
    [self addChildViewController:[[SquareViewController alloc] init] image:@"tab_classify_nor"  seletedImage:@"tab_classify_press"  title:@"广场"];
    [self addChildViewController:[[MessageViewController alloc] init] image:@"tab_community_nor"  seletedImage:@"tab_community_press"  title:@"卡片"];
    [self addChildViewController:[[MineViewController alloc] init] image:@"tab_me_nor"  seletedImage:@"tab_me_press"  title:@"我的"];
}
